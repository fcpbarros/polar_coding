...
N=512; K=256; EbN0dBrange=0:2:8; designSNRdB=0;
Ec = 1;
N0 = 2;
EbN0dB = EbN0dBrange;
...
%     BER(j) = BER(j)/(K*l);
 ...
 legenda = sprintf('%d bits e alpha = %.2f e mu = %.2f 8corr10 entr',N,alpha,mu);

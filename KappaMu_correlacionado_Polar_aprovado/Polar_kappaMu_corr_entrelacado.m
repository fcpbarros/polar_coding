...
N=2048; K=1024; EbN0dBrange=0:1:4; designSNRdB=0;
Ec = 1;
N0 = 2;
EbN0dB = EbN0dBrange;
...
%     BER(j) = BER(j)/(K*l);
 ...
 legenda = sprintf('%d bits e kappa = %.2f e mu = %.2f 8corr10 entr',N,kappa,mu);
